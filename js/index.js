...
navbar_item.forEach(function(item){
    item.addEventListener("click",function navbarClick(ele) {
        ...
        item.style.color="#DFFF0E";
    });
});
*/
var win_height=window.innerHeight;
var scroll_val;
navbar_item[0].style.color="#DFFF0E";
